...
const AddRent = ({ }: BlogPageProps) => {
    ...
    useEffect(() => {
        ...
        if (selectedUser && selectedProduct && selectAddPercen && selectDown && selectIn) {
            ...
            const downPrice = Number(selectDown)

            const processDown = basePrice + basePrice * (Number(selectAddPercen) / 100)

            sum = (processDown - downPrice) / Number(selectIn)
            setProductNewPrice(processDown)
        ...
        <div className='flex flex-col md:flex-row gap-4'>
            ...
            <Card className='w-full md:w-4/6 h-full'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <Link href='/member/rent'> <Button label='กลับหน้าหลัก' variant="outlinePrimary" shape="rounded" className='h-6  ' /></Link>
                </div>
                ...
                <div className='flex flex-row gap-4 justify-end mt-8'>
                    <Button label='ยกเลิกบิล' variant="red" shape="rounded" className='h-10  ' />
            ...
            <Card className='w-full md:w-2/6'>
                ...
                <ul className='text-end mt-4 text-lg'>
                    <li> <p>ราคามือถือ : {selectedProduct?.price || "0.00"} บาท</p></li>
